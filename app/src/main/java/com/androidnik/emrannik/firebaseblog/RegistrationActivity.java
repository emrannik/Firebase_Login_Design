        ...
        tvsignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(emailTxt.isEmpty()){
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(emailTxt,pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                startActivity(new Intent(RegistrationActivity.this,AccountSetUpActivity.class));
                                //HomeActivity instead of AccountSetUpActivity//
                            }else {
                                Toast.makeText(RegistrationActivity.this,"Create Account unsuccesful, try again",Toast.LENGTH_LONG).show();
                            }
                    ...
                    Toast.makeText(RegistrationActivity.this,"Password don't match",Toast.LENGTH_LONG).show();
                }
            }
        });
